...
public class Main implements GLEventListener, KeyListener {
    ...
    private float camX = -400.0f;
    private float camY = 400.0f;
    private float camZ = -400.0f;
    private float camW = 400.0f;
    private int zoom=0;
    ...
    public void display(GLAutoDrawable arg0) {
        ...
        glu.gluOrtho2D(camX, camY, camZ, camW);
...
//		gl.glDisable(gl.GL_LIGHTING); //TODO: [D] FixMe: check if lighting and texture is enabled
    ...
    public void q1() {
        ...
        gl.glPointSize(2.0f);//mudar para ponto
