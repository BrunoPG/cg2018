...
public final class Transformacao4D {
    ...
    /**
     * Aplica a matriz de transformação no ponto4D.
     *
     * @param point ponto4D
     * @return ponto 4D com transformação
     */
    ...
    /**
     * aplica a metriz de tranaformação na matriz passada por parâmetros.
     *
     * @param t objeto Transformacao4D
     * @return retorna matrix de transformação
     */
    ...
    /**
     * retorna elemento na matriz.
     *
     * @param index indice do alamento.
     * @return retona o valor do elemento na matriz
     */
    ...
    /**
     * setar um valor no indice da matriz
     *
     * @param index indice
     * @param value valor
     */
